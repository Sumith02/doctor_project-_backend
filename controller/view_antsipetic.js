...
module.exports = (req, res, next) => {
    ...
    const sql = 'SELECT medicine_id, medicine_name, medicine_category, medicine_company, medicine_description, medicine_category, manufacture_date, expiry_date, quantity, price FROM medicine WHERE medicine_category = "Antiseptic"';
